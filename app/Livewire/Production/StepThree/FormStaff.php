...
class FormStaff extends Component implements HasForms
{
    ...
    public function create(): void
    {
        ...
        $this->dispatch('refreshStaffList');
        Notification::make()
...
//         return $form
//         ->schema([
//              CheckboxList::make('role_name')
//              ->options($this->staff->all()->pluck('role_name', 'id')->toArray())
//              ->reactive()
//         ])
...
//         foreach ($this->staff->all() as $employeed) {
...
//     }
//     public function reloadFormSelectedStaff()
//     {
